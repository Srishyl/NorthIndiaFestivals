...
class MainActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.setOnMapClickListener { latLng ->
            ...
            // 🔄 Fallback if Geocoder fails or times out
            if (stateName == null) {
            ...
            if (stateName != null && northIndianStates.contains(stateName)) {
                ...
                android.widget.Toast.makeText(
                    this,
                    "Could not detect or outside North India region.",
    ...
    private fun getApproximateState(lat: Double, lon: Double): String? {
        return when {
            // Rough coordinate boxes for North India states
